...
fun FeedDeleteConfirmationDialog(
    ...
    DeleteConfirmationDialog(
        title = stringResource(id = R.string.feed_delete_confirmation_title),
        ...
        deleteButtonText = stringResource(id = R.string.feed_delete_confirmation_delete),
        cancelButtonText = stringResource(id = R.string.feed_delete_confirmation_cancel),
        onDeleteClick = {
